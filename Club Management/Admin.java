...
import precursor.sportsmanagementproject.AddStaff;
import precursor.sportsmanagementproject.UpdateStaff;
import precursor.sportsmanagementproject.DeleteStaff;
...
public void createGui()
{
	...
	JMenu mnAccount = new JMenu("Staff's Account");
	...
	mnPlans.add(mntmDelete);
	 ...
	 btnStaff = new JButton("Staff's Section");
	btnStaff.addActionListener(this);
	btnStaff.setBounds(1033, 11, 122, 36);
	...
	public void actionPerformed(ActionEvent e) {
		...
		{
			AddStaff ac=new AddStaff();
			ac.setVisible(true);
		}
		if(caption.equals("Update Account"))
		{
			UpdateStaff uc=new UpdateStaff();
			uc.setVisible(true);
		}
		if(caption.equals("Delete Account"))
		{
			DeleteStaff dc=new DeleteStaff();
			dc.setVisible(true);
		}
